 ...
 *
 * Censuses can run concurrently on platform scheduler threads, so every
 * counter is a LongAdder and the per-species and per-world maps are
 * concurrent. Readers (the /wildlife status command, periodic summary, and
 * Prometheus endpoint) take a consistent-enough snapshot without world access.
 *
 * The instance is owned by the platform runtime and survives /wildlife reload, so the
...
public final class BalancerStats {
    ...
    public void censusRan() { censusRuns.increment(); }
    public void skippedRegionBoundary() { skippedRegionBoundary.increment(); }
    public void skippedSharedCell() { skippedSharedCell.increment(); }
    public void skippedDisabledWorld() { skippedDisabledWorld.increment(); }
    public void censusFailed() { censusFailures.increment(); }
    public void deficitObserved() { deficitsObserved.increment(); }
    public void blockedByStreak() { blockedByStreak.increment(); }
    public void blockedByBudget() { blockedByBudget.increment(); }
    public void noSpawnSpot() { noSpawnSpot.increment(); }
    public void emptyBiomePool() { emptyBiomePool.increment(); }

    public void spawned(String world, String species, int count) {
    ...
    public record Gauges(int activeCells, int cellsOnStreak, int cellsBudgetSpent) {}
    ...
    public static List<String> statusLines(Snapshot s, Gauges g) {
    ...
    public static String summaryLine(Snapshot s, Gauges g) {
     ...
     */
    public static String prometheus(Snapshot s, Gauges g) {
    ...
    public static String promEscape(String v) {
