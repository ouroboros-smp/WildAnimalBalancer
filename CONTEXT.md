...
- Biome overrides. `biome-animals` swaps the species list per biome, or disables a biome with an empty list, so spawns stay biome-appropriate where that matters.
