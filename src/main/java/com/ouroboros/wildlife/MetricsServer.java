 ...
 * on the metrics thread and must NEVER touch world or entity state (that would
 * violate the Folia region-ownership rules).
 */
final class MetricsServer {
    ...
    static MetricsServer start(String bind, int port, Supplier<String> scrape) throws IOException {
